...
BLYNK_AUTH = '1EWSq_x7ATOX7ejvCMx5OwNVF9RtOFIe' #insert your Auth Token here
# base lib init
...
def read_virtual_pin_handler(pin):
    ...
    if sensor_data >= critilcal_data_value:
        ...
        blynk.set_property(pin, 'color', '#FFFF00') # set red color for the widget UI element 
